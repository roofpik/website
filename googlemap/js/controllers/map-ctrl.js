...
$('.draggable').attr('draggable', true);
     ...
     function initMap() {
         ...
         var markers = [
             ...
             ['Shona Road, NY', 28.416920, 77.042746, 'images/marker1.png'],
             ['IFFCO Chowk Metro Station, NY', 28.471623, 77.072390, 'images/marker2.png'],
             ['Huda Metro Station, NY', 28.459552, 77.072430, 'images/marker3.png']
         ...
         var infoWindowContent = [
             ...
             ['<div class="info_content">' +
                 ...
                 '<div class="cardTitle row mgbn">' +
                 '<a class="col m7 black-text text-lighten-4 bod-right pd-tspanmap">' +
                 '<span class="b">Bestech Park View City 1</span>' +
                 '<span class="ft12">Sohna Road, Sector 48 Gurgaon</span>' +
                 '</a>' +
                 '<div class="col m4 bod-right ft12i">' +
                 ...
                 '<a><img src="images/sohna.jpg"></a>' +
                 '</div>' +
                 '<div class="row mg0 ht50">' +
                 '<div class="col m6 pd5 dis-tab center bod-right ht50">' +
